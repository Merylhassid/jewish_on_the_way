# Chiang Mai Synagogues Bulk Import PowerShell Script
# Imports synagogue records for destination 473
# Usage: .\import-chiang-mai-synagogues.ps1 -Email "admin@example.com" -Password "password"
#        or with defaults: .\import-chiang-mai-synagogues.ps1
...
$payload = @(
    @{
        name = "Chabad House Chiang Mai"
        destinationId = 473
        address = "189 Changklan Rd, Tambon Chang Khlan, Amphoe Mueang Chiang Mai, Chiang Mai 50100, Thailand"
        phone = "+66 86 111 1770"
        website = "https://chabadthailand.co.il/"
        latitude = 18.77715
        longitude = 98.99971
        description = "Chabad House and synagogue in Chiang Mai serving Jewish travelers with daily prayers, Shabbat meals, kosher food, holiday services and community support. Weekdays: Sunday-Thursday 10:30-21:00, Friday 10:00-14:30, Shabbat from 09:30 until 22:00. Shabbat: Shacharit 10:00, Mincha and Kabbalat Shabbat at candle lighting time, Seudah Shlishit and Havdalah at the end of Shabbat. WhatsApp contact: +66 81 989 4438. Email: cm@chabadthailand.com. Google Maps: https://maps.app.goo.gl/xhcnfbP3jY8TQk5q7"
    }
)
