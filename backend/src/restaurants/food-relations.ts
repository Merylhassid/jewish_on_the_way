...
export const FOOD_RELATIONS: Record<string, FoodRelation> = {
  ...
  'מאפה':      { searchTags: ['bakery', 'cafe'],                  fallbackType: 'dairy' },
  'מאפים':     { searchTags: ['bakery', 'cafe'],                  fallbackType: 'dairy' },
  'סמבוסק':    { searchTags: ['bakery', 'street-food'],           fallbackType: 'dairy' },
  'גבינה':     { searchTags: ['cafe', 'pizza', 'pasta'],          fallbackType: 'dairy' },
  'גבינות':    { searchTags: ['cafe', 'pizza', 'pasta'],          fallbackType: 'dairy' },
